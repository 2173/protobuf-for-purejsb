...
public static MethodID methodID17 = new MethodID("Instantiate", "T", TypeFlag.IsT, new string[]{"T"}, new TypeFlag[]{TypeFlag.IsT});

static bool Object_InstantiateT1__T(JSVCall vc, int argc)
{
    // Get generic method by name and param count.
    MethodInfo method = JSDataExchangeMgr.makeGenericMethod(typeof(UnityEngine.Object), methodID17, 1); 
    if (method == null) return true;
